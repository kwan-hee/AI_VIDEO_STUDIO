...
<!-- 출처: https://github.com/snflkd/fluent-korean (plugins/fluent-korean/output-styles/fluent-korean-not-coding.md, v1.0.0, MIT License). '추가 사항' 절은 저장소 README의 '세부 동작' 블록에서 선택해 추가한 것이며 원본에는 없습니다. -->
